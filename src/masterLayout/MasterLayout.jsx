      ...
      >
                    ...
                    <div className="max-h-400-px overflow-y-auto scroll-sm pe-4">
                      ...
                      >
                        ...
                        <div className="d-flex flex-column align-items-end">
                          ...
                          <span className="mt-4 text-base w-16-px h-16-px d-flex justify-content-center align-items-center bg-warning-main rounded-circle">
                            8
                          </span>
                        </div>
                      </Link>
                      ...
                      >
                        ...
                        <div className="d-flex flex-column align-items-end">
                          ...
                          <span className="mt-4 text-base w-16-px h-16-px d-flex justify-content-center align-items-center bg-neutral-400 rounded-circle">
                            0
                          </span>
                        </div>
                      </Link>
        ...
        <footer className="d-footer">
          <div className="row align-items-center justify-content-between">
            ...
            <div className="col-auto">
              <p className="mb-0">
                Made by <span className="text-primary-600">Smart School</span>
              </p>
            </div>
          </div>
        </footer>
