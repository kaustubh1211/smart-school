...
const SignInLayer = () => {
  ...
  return (
    <section className="auth bg-gray-100 min-vh-100 d-flex align-items-center justify-content-center">
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-12 col-lg-10 col-xl-10">
            <div
              className="card shadow-lg border-0 overflow-hidden"
              style={{ borderRadius: "16px" }} // Add height here
            >
              <div className="row g-0">
                <div className="auth-left col-lg-6 d-lg-block d-none">
                  <div className="d-flex align-items-center flex-column h-100 bg-white justify-content-center p-4">
                    <img src="/assets/images/auth/logo.jpg" alt="" />
                  </div>
                </div>
                <div className="auth-right col-lg-6 py-32 px-24 d-flex flex-column justify-content-center bg-white">
                  <div className="max-w-464-px mx-auto w-100">
                    <div>
                      <Link to="/" className="max-w-44">
                        <img
                          src="/assets/images/auth/smart-school-main.jpg"
                          className="mix-blend-hard-light mb-2"
                          alt=""
                          style={{ marginLeft: "-1px" }} // move left
                        />
                      </Link>
